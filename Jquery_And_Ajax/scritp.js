$('#btnSubmit').click(function() {
    $.ajax({
      ...
      {                  txt += $('#user-logged').append(maindata[i].name)+$('#data_username').append(maindata[i].user)
                  +$('#data_password').append(maindata[i].password)+$('#data_name').append(maindata[i].name)  
                  +$('#data_email').append(maindata[i].email)+$('#data_phone').append(maindata[i].phone);
              }
             }
              if(txt != ""){
